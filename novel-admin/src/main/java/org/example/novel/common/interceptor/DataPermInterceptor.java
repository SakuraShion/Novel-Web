package org.example.novel.common.interceptor;
...
import org.example.novel.system.domain.SysDataPerm;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (methodName.endsWith("ByPerm")) {
            ...
            if (tableNameMatcher.find()) {
                ...
                List<SysDataPerm> perms = user.getDataPerms().get(tableName);
                String pageSql = "";
